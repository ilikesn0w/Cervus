/*
 ...
 Created by alex on 6/24/26.
 Displays OS, hostname, kernel, uptime, CPU, RAM, disk usage, shell, terminal, desktop env, and a random quote.
 
 * General Features:
 *  
 *  ** Custom ASCII logo (Cervus deer)
 *  
 *  ** Colorful output with ANSI escape codes
 *  
 *  ** Automatic aligment of values
 *  
 *  ** Random tech quote on each run 
 *  
 *  
 *  ** Uses native Cervus system calls (cervus_uptime_ns, cervus_meminfo, cervus_list_mounts, cervus_disk_info) and standart POSIX (uname, getenv).
